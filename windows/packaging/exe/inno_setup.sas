...
[UninstallDelete]
Type: filesandordirs; Name: "{userappdata}\V2ET"
...
var
  ResultCode: Integer;
begin
  Exec('taskkill', '/F /IM V2ET.exe', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
  Exec('taskkill', '/F /IM hiddify.exe', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
  Exec('net', 'stop "V2ETTunnelService"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
  Exec('sc.exe', 'delete "V2ETTunnelService"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
